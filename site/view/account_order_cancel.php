...
$sql_order_list = "SELECT * FROM orders JOIN account ON orders.account_id = account.account_id WHERE orders.order_status = -1 AND account.account_id = $account_id ORDER BY orders.order_id DESC";
