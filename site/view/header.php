...
<header class="header">
    <div class="header__topbar">
        <div class="container p-relative d-flex space-between align-center">
            ...
            ?>
                <a class="h5 login-btn p-absolute" href="index.php?logout=1"><?php echo $row_account['account_name'] ?> |<img class="image_login" src="./assets/images/icon/log-out.png" alt="Đăng xuất"><span>ĐĂNG XUẤT</span></a>
                <?php
                }
                ?>
                ...
                <nav class="header__nav space-between d-flex">
                    <ul class="nav__list md-flex">
                        ...
                        <li class="nav__item nav__items h7">
                            <span class="nav__anchor shop p-relative h7 d-flex align-center space-between w-100 cursor-pointer" href="#">
                                CỬA HÀNG
                            ...
                            <ul class="header__subnav p-absolute">
                                ...
                                <li class="nav__item">
                                    <a class="nav__anchor2 h7 d-flex align-center space-between" href="index.php?page=products">
                                        TẤT CẢ SẢN PHẨM
                                    </a>
                                </li>
                                <?php
                                ...
                                ?>
                                    <hr>
                                    <li class="nav__item">
                                        <a class="nav__anchor2 h7 d-flex align-center space-between" href="index.php?page=products&category_id=<?php echo $row_category['category_id'] ?>">
                        ...
                        <li class="nav__item nav__items h7">
                            <span class="nav__anchor collab p-relative h7 d-flex align-center space-between w-100 cursor-pointer" href="#">
                                BỘ SƯU TẬP
                                <img class="md-none svg__icon" src="./assets/images/icon/icon-nextlink.svg" alt="next" />
                                <img class="d-none md-block svg__icon" src="./assets/images/icon/icon-chevron-down.svg" alt="back" style="margin-left: 8px" />
                            </span>
