...
$sql_get_size = "SELECT * FROM product_size WHERE product_id = '$product_id'";  
$query_get_size = mysqli_query($mysqli, $sql_get_size);
...
<div class="product-detail">
    <div class="product-detail__container background-default pd-section-product-detail">
        <div class="container">
            <div class="row">
                ...
                <div class="col pd-t-30" style="--w-md: 5">
                    <div class="product-detail__info">
                        <form method="POST"
                            action="site/handle/addtocart.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
                            ...
                            <span class="review-star-list d-flex align-center">
                                ...
                                <?php
                                    ...
                                    ?>
                                <span class="point-comment h9">(<?php echo $rate_avg ?> Stars /
                                    <?php echo $count_rate ?> Reviews)</span>
                            </span>
                            ...
                            <div class="product-detail__price d-flex align-center">
                                <?php
                                    ...
                                    ?>
                                <del
                                    class="product__price--old "><?php echo number_format($row_product_detail['product_price']) . ' ₫' ?></del>
                                <?php
                                    }
                                    ?>

                                <span
                                    class="product__price--new "><?php echo (number_format($row_product_detail['product_price'] - ($row_product_detail['product_price'] / 100 * $row_product_detail['product_sale']))) . ' ₫' ?></span>
                                <?php
                                    if ($row_product_detail['product_sale'] > 0) {
                                    ?>
                            ...
                            <span class="h5 product-code">Mã sản phẩm:
                                <?php echo $row_product_detail['product_id'] ?></span><br>
                            <span class="h5 product-code">Số lượng còn:
                                <?php if ($row_product_detail['product_quantity'] > 0) { ?><span class="quantity-total">
                                ...
                                <div class="product-detail__quantity">
                                    ...
                                    <div class="d-flex align-center">
                                        <div class="select__number p-relative">
                                            ...
                                            <input type="text" name="product_quantity" min="1" value="1"
                                    ...
                                    <div class="d-flex align-center">
                                        <div class="select__option p-relative">
                                            <select name="product_size" id="product_size">
                                                <?php 
                                                    while($size = mysqli_fetch_array($query_get_size)) {
                                                    ?>
                                                <div class="size__option selectbox__item">
                                                    <option class="h5 size__option"
                                                        value="<?php echo $size['variant_id'] ?>">

                                                        <?php echo $size['variant_name'] ?>
...
<section class="faq-tab pd-bottom" id="info-product">
    ...
    <div class="tab__content">
        <div class="container">
            ...
            <div class="tab-pane">
                <div class="row">
                <div class="comment-form col" style="--w-md:8;">
                    <form class="post-comment" method="POST"
                        ...
                        <div class="d-flex align-center mg-t-10 ">
                            <?php
                                if (isset($_SESSION['account_id'])) {
                                ?>
                            <button class="btn__evualate" name="evaluate_add" type="submit">Gửi</button>
                            <?php
                                } else {
                                ?>
                ...
                <div class="evaluate__rating d-flex align-center col" style="--w-md:4;">
                ...
                <div class="evaluate__content mg-t-10">
                    <?php
                        while ($evaluate = mysqli_fetch_array($query_evaluate)) {
                        ?>
                    <div class="comment-item d-flex">
                        <div class="f-cmuser"><abbr
                                title=""><?php echo substr($evaluate['account_name'], 0, 1) ?></abbr></div>
