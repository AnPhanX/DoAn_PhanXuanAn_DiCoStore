...
if (isset($_GET['order_type']) && $_GET['order_type'] == 1) {
    ...
    //them lich su giao dịch vao bang vnpay
    ...
    <div class="container">
        <div class="thankiu__box text-center">
            ...
            <div class="thankiu_link">
                ...
                <a href="index.php?page=my_account&tab=account_order" class="btn__view__order mg-t-20">Xem chi tiết</a>
            </div>
        </div>
    </div>
</section>
...
<section class="thankiu">
    <div class="container">
        <div class="thankiu__box text-center">
            <div class="thankiu_image">
                <img src="assets/images/icon/icon_error_od.gif" alt="success">
            </div>
            <h1 class="thankiu__heading heading--wanning h2">Giao dịch thất bại!</h1>

            <div class="thankiu_link">
                <!-- <a href="index.php" class="btn btn__outline">Trang chủ</a> -->
                <a href="index.php?page=cart" class="btn__view__order mg-t-20">Quay lại giỏ hàng</a>
            </div>
        </div>
    </div>
</section>
